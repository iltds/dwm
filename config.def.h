...
static const Key keys[] = {
	...
	{ MODKEY,			XK_backslash,	spawn,          {.v = rofi } },
	{ MODKEY,                       XK_p,      	spawn,          {.v = dmenucmd } },
	{ MODKEY,                       XK_Return, 	spawn,          {.v = termcmd } },
	{ MODKEY,                       XK_v, 		spawn,          {.v = browser } },
	{ MODKEY,                       XK_b,      	togglebar,      {0} },//esconder barra
	{ MODKEY,                       XK_s,      	focusstack,     {.i = +1 } },//trocar janela
	{ MODKEY,                       XK_w,      	focusstack,     {.i = -1 } },//trocar janela
	{ MODKEY,                       XK_i,      	incnmaster,     {.i = +1 } },
	{ MODKEY,                       XK_u,      	incnmaster,     {.i = -1 } },
	{ MODKEY,                       XK_a,      	setmfact,       {.f = -0.05} },//controlar tamanho
	{ MODKEY,                       XK_d,      	setmfact,       {.f = +0.05} },//controlar tamanho
	{ MODKEY,                       XK_space, 	zoom,           {0} },//alternar janela
	{ MODKEY,                       XK_Tab,    	view,           {0} },//alternar tag
	{ MODKEY,	                XK_q,      	killclient,     {0} },//fechar app
	{ MODKEY,                       XK_t,      	setlayout,      {.v = &layouts[0]} },
	{ MODKEY,                       XK_f,      	setlayout,      {.v = &layouts[1]} },
	{ MODKEY,                       XK_m,      	setlayout,      {.v = &layouts[2]} },
	{ MODKEY,                       XK_o,  	   	setlayout,      {0} },//layout
	{ MODKEY|ShiftMask,             XK_o,      	togglefloating, {0} },//layout
